...
fun main() {
    ...
    val key = "L3prRpKEBSTW2HCNXA699mXsMECUZPdP4GXJb4otEDe4SZc7ooEa"
    //String prv = "xprv9s21ZrQH143K4L1hLRdSd8i4QDHV2CUFCU5km4EjSJC4BHN1wDQa8uLWPJGQU1krHP3uiT2APA1DhfDqZr1kLXePxXk7x5GiFyyheBk1bVw";
    ...
    val Original_Key = Arrays.copyOfRange(decoded, 1, 33)
    println(Arrays.toString(Original_Key))

    //String prikey = util.BaseShift.bytesToHex(Original_Key);
    val privkey = Original_Key.ByteArrayToHex()
    println("\nPrivate Key: \n\t└── " + privkey)

    val encodeKey = privkey
    println(encodeKey.encodeBase58())
}